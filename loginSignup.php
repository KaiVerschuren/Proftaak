...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // please complete this post so i get the values that the user put in, and a variable that indicates the state, so for example "logIn" or "signUp" class="loginform"
}
                ...
                <form class="loginForm" action="index.php" method="post">
                    <ul class="noStyleUL loginUL">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <input class="loginFormInput loginFormEmail" type="text" placeholder="Enter your email">
                        </li class="loginInputList">
                        <li class="loginInputList">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="loginPasswordSvg">
                            ...
                            <input class="loginFormInput loginPassword" type="password" name="Password" placeholder="Password">
                ...
                <form class="loginForm" action="index.php" method="post">
                    <ul class="noStyleUL">
                        <li class="loginInputList">
                            ...
                            <input class="loginFormInput loginFormDisplay" type="text" placeholder="Enter your display name">
                        </li>
                        <li class="loginInputList">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 12a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Zm0 0c0 1.657 1.007 3 2.25 3S21 13.657 21 12a9 9 0 1 0-2.636 6.364M16.5 12V8.25" />
